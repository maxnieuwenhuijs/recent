...
export default class PersonList extends React.Component {
    ...
    componentDidMount() {
            ...
            axios.get(`https://adminportal.dating/api/favorite/${getUserId()}/3`)
                .then(res => {
               ...
               {loading ? (
                        ...
                        <Container xs={12}  maxWidth="md">
                            <Box sx={{ marginTop: 2, height: '90vh', overflow: 'auto' }} container spacing={{ xs: 1, md: 1 }} columns={{ xs: 1, sm: 1, md: 1 }} >
                                <Card>
                                    {empty ? <div>Please favorite some profiles!</div>
                                                        ...
                                                        <Link style={{ color: 'inherit', textDecoration: 'inherit' }} to={`/profile/${profile.member_id}`}>
                                                            <ListItem >
                                                                <ListItemButton alignItems="flex-end">
                                                                    <ListItemAvatar>
                                                                        <Avatar alt="Remy Sharp" src={`https://adminportal.dating/api/profile/${profile.member_id}_0.jpg`} />
                                                                    </ListItemAvatar>
                                                                    <ListItemText
                                                                        primary={
                                                                            <React.Fragment>
